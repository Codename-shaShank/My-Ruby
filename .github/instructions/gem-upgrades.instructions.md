...
# Copilot instructions – Dependabot gem upgrades

## Overview

- Use these instructions only for Dependabot gem‑upgrade PRs.
...
- Increase risk level when:
  ...
  - The gem is core to application behavior (HTTP, DB, job processing, AWS SDK, etc.).
...
- Extract only the most relevant points:
  ...
  - Security fixes.
  - Notable new behavior that might affect the application.
